...
/*void ACL_Init()
{
    ...
    ACL_SetRegister(ACL_CTRL_REG4, 1);        // Activer le data ready
    ACL_SetRegister(ACL_CTRL_REG5, 0);        // Router a la pin2 les interrupts
...
void task_createPaquet()
{
    ...
    //{
        ...
        //UDP_Send_Buffer[1 + count] = accelX;
        //UDP_Send_Buffer[41 + count] = accelY;
        //UDP_Send_Buffer[81 + count] = accelZ;
        ...
        //{
            ...
            //UDP_Send_Buffer[0] = entete_counter; //l'entete du paquet
            //entete_counter++;
           // SYS_CONSOLE_PRINT("%d %d %d %d \r\n", UDP_Send_Buffer[0], UDP_Send_Buffer[1], UDP_Send_Buffer[2], UDP_Send_Buffer[3]);
            
            //UDP_Send_Buffer[484] = '\0'; illegal!!
            //count = 0;
        //}
...
//unsigned int compteurSSD = 0;
/*void accel_tasks() // POUR LAFFICHAGE UNIQUEMENT
{
    ...
    /*if(accel_data_ready)
    {
            if(SWITCH1StateGet())
        {
            ...
            SSD_WriteDigitsGrouped(compteurSSD++, 0x1);
