...
void SYS_Initialize ( void* data )
{
    ...
    /*set priority int timer 3 pour PWM*/
    /*SYS_INT_VectorPrioritySet(_TIMER_3_VECTOR, INT_PRIORITY_LEVEL2);
    SYS_INT_VectorSubprioritySet(_TIMER_3_VECTOR,INT_SUBPRIORITY_LEVEL0);
      */       
