...
HD_PWD='C:/Users/Alexi/OneDrive/S4/APP4/S4e_Depart_etud/S4e_Depart.runs/main_design_ilmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_design_ilmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_design_ilmb_bram_if_cntlr_0.tcl
