...
architecture STRUCTURE of design_1_xbar_0_axi_crossbar_v2_1_23_addr_arbiter_sasd is
  ...
  attribute SOFT_HLUTNM of \gen_arbiter.m_grant_hot_i[1]_i_3\ : label is "soft_lutpair43";
  attribute SOFT_HLUTNM of \gen_arbiter.m_grant_hot_i[1]_i_4\ : label is "soft_lutpair21";
  ...
  attribute SOFT_HLUTNM of \m_axi_wdata[0]_INST_0\ : label is "soft_lutpair42";
  ...
  attribute SOFT_HLUTNM of \m_axi_wdata[25]_INST_0\ : label is "soft_lutpair30";
  ...
  attribute SOFT_HLUTNM of \m_axi_wdata[2]_INST_0\ : label is "soft_lutpair41";
  ...
  attribute SOFT_HLUTNM of \m_axi_wdata[3]_INST_0\ : label is "soft_lutpair41";
  attribute SOFT_HLUTNM of \m_axi_wdata[4]_INST_0\ : label is "soft_lutpair40";
  attribute SOFT_HLUTNM of \m_axi_wdata[5]_INST_0\ : label is "soft_lutpair40";
  ...
  attribute SOFT_HLUTNM of \m_axi_wdata[8]_INST_0\ : label is "soft_lutpair38";
  ...
  attribute SOFT_HLUTNM of \s_axi_bresp[1]_INST_0_i_8\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \s_axi_bvalid[1]_INST_0_i_2\ : label is "soft_lutpair24";
...
\gen_arbiter.m_grant_hot_i[1]_i_12\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00020C0000020000"
        ...
        port map (
      I0 => m_axi_awready(3),
      I1 => \gen_arbiter.m_grant_hot_i[1]_i_11_0\(1),
      I2 => \gen_arbiter.m_grant_hot_i[1]_i_11_0\(0),
      I3 => \gen_arbiter.m_grant_hot_i[1]_i_11_0\(2),
      I4 => \gen_arbiter.m_grant_hot_i[1]_i_11_0\(3),
      I5 => m_axi_awready(1),
...
\gen_arbiter.m_grant_hot_i[1]_i_15\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \gen_arbiter.m_grant_hot_i[1]_i_11_0\(1),
      I2 => \gen_arbiter.m_grant_hot_i[1]_i_11_0\(0),
      I3 => \gen_arbiter.m_grant_hot_i[1]_i_11_0\(3),
      I4 => \gen_arbiter.m_grant_hot_i[1]_i_11_0\(2),
      I5 => m_axi_arready(7),
...
\gen_arbiter.m_grant_hot_i[1]_i_16\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"EFFF"
        ...
        port map (
      I0 => \gen_arbiter.m_grant_hot_i[1]_i_11_0\(2),
      I1 => \gen_arbiter.m_grant_hot_i[1]_i_11_0\(3),
      I2 => \gen_arbiter.m_grant_hot_i[1]_i_11_0\(1),
...
\m_ready_d[2]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \gen_arbiter.m_grant_hot_i[1]_i_11_0\(2),
      I2 => \gen_arbiter.m_grant_hot_i[1]_i_11_0\(3),
      I3 => \gen_arbiter.m_grant_hot_i[1]_i_11_0\(1),
      I4 => \gen_arbiter.m_grant_hot_i[1]_i_11_0\(0),
      I5 => m_axi_awready(2),
...
\s_axi_bresp[1]_INST_0_i_8\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFEF"
        ...
        port map (
      I0 => \gen_arbiter.m_grant_hot_i[1]_i_11_0\(1),
      I1 => \gen_arbiter.m_grant_hot_i[1]_i_11_0\(0),
...
architecture STRUCTURE of design_1_xbar_0_axi_register_slice_v2_1_22_axic_register_slice is
  ...
  attribute SOFT_HLUTNM of \s_axi_bresp[0]_INST_0_i_2\ : label is "soft_lutpair56";
  ...
  attribute SOFT_HLUTNM of \skid_buffer[34]_i_2\ : label is "soft_lutpair57";
begin
...
addr_arbiter_inst: entity work.design_1_xbar_0_axi_crossbar_v2_1_23_addr_arbiter_sasd
     port map (
      ...
      aclk => aclk,
      aresetn_d => aresetn_d,
      aresetn_d_reg(3) => addr_arbiter_inst_n_16,
      aresetn_d_reg(2) => addr_arbiter_inst_n_17,
      aresetn_d_reg(1) => addr_arbiter_inst_n_18,
      aresetn_d_reg(0) => addr_arbiter_inst_n_19,
      aresetn_d_reg_0_sp_1 => addr_arbiter_inst_n_51,
      aresetn_d_reg_1_sp_1 => addr_arbiter_inst_n_52,
      ...
      \gen_arbiter.m_grant_hot_i[1]_i_5_0\ => splitter_aw_n_3,
      \gen_arbiter.m_grant_hot_i[1]_i_5_1\ => splitter_aw_n_4,
      \gen_arbiter.m_grant_hot_i[1]_i_6\ => reg_slice_r_n_39,
      ...
      \m_atarget_enc_reg[2]\ => addr_arbiter_inst_n_70,
      \m_atarget_hot_reg[9]\ => addr_arbiter_inst_n_146,
      \m_atarget_hot_reg[9]_0\ => addr_arbiter_inst_n_147,
      m_axi_arready(7 downto 0) => m_axi_arready(8 downto 1),
      m_axi_arready_4_sp_1 => addr_arbiter_inst_n_56,
      m_axi_arready_5_sp_1 => addr_arbiter_inst_n_57,
...
\gen_decerr.decerr_slave_inst\: entity work.design_1_xbar_0_axi_crossbar_v2_1_23_decerr_slave
     port map (
      ...
      \gen_axilite.s_axi_awready_i_reg_2\ => addr_arbiter_inst_n_147,
...
reg_slice_r: entity work.design_1_xbar_0_axi_register_slice_v2_1_22_axic_register_slice
     port map (
      ...
      \gen_arbiter.m_grant_hot_i_reg[1]_0\ => addr_arbiter_inst_n_57,
      \gen_arbiter.m_grant_hot_i_reg[1]_1\ => addr_arbiter_inst_n_56,
      \gen_arbiter.m_grant_hot_i_reg[1]_2\ => addr_arbiter_inst_n_54,
      \gen_arbiter.m_valid_i_i_2\ => addr_arbiter_inst_n_58,
...
entity design_1_xbar_0_axi_crossbar_v2_1_23_axi_crossbar is
  ...
  attribute C_M_AXI_BASE_ADDR of design_1_xbar_0_axi_crossbar_v2_1_23_axi_crossbar : entity is "576'";
  ...
  attribute C_NUM_MASTER_SLOTS of design_1_xbar_0_axi_crossbar_v2_1_23_axi_crossbar : entity is 9;
  ...
  attribute P_M_AXI_SUPPORTS_READ of design_1_xbar_0_axi_crossbar_v2_1_23_axi_crossbar : entity is "9'b111111111";
  attribute P_M_AXI_SUPPORTS_WRITE : string;
  attribute P_M_AXI_SUPPORTS_WRITE of design_1_xbar_0_axi_crossbar_v2_1_23_axi_crossbar : entity is "9'b111111111";
...
architecture STRUCTURE of design_1_xbar_0 is
  ...
  attribute C_M_AXI_BASE_ADDR : string;
  attribute C_M_AXI_BASE_ADDR of inst : label is "576'";
  attribute C_M_AXI_READ_CONNECTIVITY : string;
