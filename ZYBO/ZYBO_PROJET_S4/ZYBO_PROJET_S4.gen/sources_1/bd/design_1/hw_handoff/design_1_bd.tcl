...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_ATG_SYSTEM_CH1_HIGH {0x00040000} \
   CONFIG.C_ATG_SYSTEM_CH1_LOW {0x00000000} \
   CONFIG.C_ATG_SYSTEM_INIT_ADDR_MIF {i2sadd.coe} \
   CONFIG.C_ATG_SYSTEM_INIT_DATA_MIF {i2sdata.coe} \
 ] $axi_traffic_gen_0
  ...
  connect_bd_intf_net -intf_net axi_traffic_gen_0_M_AXI_LITE_CH1 [get_bd_intf_pins axi_traffic_gen_0/M_AXI_LITE_CH1] [get_bd_intf_pins i2s_receiver_0/s_axi_ctrl]
  ...
  connect_bd_net -net clk_wiz_1_clk_out2 [get_bd_ports ac_mclk] [get_bd_pins clk_wiz_1/clk_out2] [get_bd_pins i2s_receiver_0/aud_mclk] [get_bd_pins ila_0/probe3] [get_bd_pins rst_clk_wiz_1_100M1/slowest_sync_clk]
  ...
  connect_bd_net -net i2s_receiver_0_lrclk_out [get_bd_ports ac_reclrc] [get_bd_pins i2s_receiver_0/lrclk_out] [get_bd_pins ila_0/probe2]
  connect_bd_net -net i2s_receiver_0_m_axis_aud_tdata [get_bd_pins i2s_receiver_0/m_axis_aud_tdata] [get_bd_pins ila_0/probe0]
  connect_bd_net -net i2s_receiver_0_m_axis_aud_tvalid [get_bd_pins i2s_receiver_0/m_axis_aud_tvalid] [get_bd_pins ila_0/probe4]
  connect_bd_net -net i2s_receiver_0_sclk_out [get_bd_ports ac_bclk] [get_bd_pins i2s_receiver_0/sclk_out]
  connect_bd_net -net m_axis_aud_tready_0_1 [get_bd_ports swt0] [get_bd_pins i2s_receiver_0/m_axis_aud_tready]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_clk_wiz_1_100M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_traffic_gen_0/s_axi_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins i2s_receiver_0/m_axis_aud_aclk] [get_bd_pins i2s_receiver_0/s_axi_ctrl_aclk] [get_bd_pins ila_0/clk] [get_bd_pins mdm_1/S_AXI_ACLK] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_axi_periph/S01_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M1_peripheral_reset [get_bd_pins i2s_receiver_0/aud_mrst] [get_bd_pins rst_clk_wiz_1_100M1/peripheral_reset]
  connect_bd_net -net rst_clk_wiz_1_100M_bus_struct_reset [get_bd_pins microblaze_0_local_memory/SYS_Rst] [get_bd_pins rst_clk_wiz_1_100M/bus_struct_reset]
  connect_bd_net -net rst_clk_wiz_1_100M_mb_reset [get_bd_pins microblaze_0/Reset] [get_bd_pins microblaze_0_axi_intc/processor_rst] [get_bd_pins rst_clk_wiz_1_100M/mb_reset]
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_traffic_gen_0/s_axi_aresetn] [get_bd_pins i2s_receiver_0/m_axis_aud_aresetn] [get_bd_pins i2s_receiver_0/s_axi_ctrl_aresetn] [get_bd_pins mdm_1/S_AXI_ARESETN] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins microblaze_0_axi_periph/S01_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x00000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces axi_traffic_gen_0/Reg1] [get_bd_addr_segs i2s_receiver_0/s_axi_ctrl/Reg] -force
