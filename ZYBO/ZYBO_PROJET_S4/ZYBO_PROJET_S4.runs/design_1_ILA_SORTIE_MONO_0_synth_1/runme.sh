...
HD_PWD='C:/Users/cbowlieu/github/Projet-S4/ZYBO/ZYBO_PROJET_S4/ZYBO_PROJET_S4.runs/design_1_ILA_SORTIE_MONO_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_ILA_SORTIE_MONO_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_ILA_SORTIE_MONO_0.tcl
